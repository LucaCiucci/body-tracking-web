...
/** @typedef { [PointName, PointName] } Connection */

/** @typedef { PointName | Connection } BodyElement */

/** @typedef { ElementDefinitionStatement, RoutineDefinition, RepeatStatement, CallStatement } Statement */

class ElementDefinitionStatement {
    /**
     * 
     * @param {string} name 
...
class RoutineDefinition {
     ...
     * 
     * @param {string} name
     * @param {RepeatStatement, CallStatement[]} body
     */
    constructor(name, body) {
        ...
        /**
         * @type {RepeatStatement, CallStatement[]}
         */
        this.body = body;
    }
}
